...
interface GraduateStudentIntf {
	void computeGrade();
}


interface UndergraduateStudentIntf {
	void computeGrade();
}
...
class GraduateStudent extends Student implements GraduateStudentIntf{
...
class UndergraduateStudent extends Student implements UndergraduateStudentIntf{
	public void computeGrade(){
